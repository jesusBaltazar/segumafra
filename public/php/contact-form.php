...
$email = 'jesus_baltazarm@hotmail.com';
//$email = 'segumafra@segumafra.com';
...
try {
	...
	//$mail->Host = 'prodiisa.com';				       // Specify main and backup server
	//$mail->SMTPAuth = true;                                  // Enable SMTP authentication
	//$mail->Username = 'administracion@prodiisa.com';                    // SMTP username
	//$mail->Password = 'Prodiisa2k21@';                              // SMTP password
